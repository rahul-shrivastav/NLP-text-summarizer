...

        {
          allchat.map((chat, index) => {
            if (index != allchat.length - 1) {
              return (
                <div key={index} className='p-3 m-2 text-black w-fit max-w-[70%] rounded-3xl rounded-tl-none bg-slate-200'>
                  {chat}
                </div>
              )
            } else {
              return (
                <div key={index} className='p-3 relative  mt-10 ml-3 text-black w-fit max-w-[70%] rounded-3xl rounded-tl-none bg-slate-200'>
